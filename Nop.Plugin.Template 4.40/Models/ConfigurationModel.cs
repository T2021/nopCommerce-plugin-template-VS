...
namespace $safeprojectname$.Models
{
    public record ConfigurationModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Plugins.Widgets.CustomPlugin.Picture")]
        [UIHint("Picture")]
        public int Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.CustomPlugin.Text")]
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.CustomPlugin.Link")]
        public string Link1 { get; set; }
        public bool Link1_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.CustomPlugin.AltText")]
